...
DROP TABLE IF EXISTS WARN CASCADE;
CREATE TABLE WARN (
    WarnID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    SellerID UUID NOT NULL REFERENCES SELLER(UserID) ON DELETE CASCADE,
    SKU_ID UUID NOT NULL REFERENCES SKU_MANAGEMENT(SKU_ID) ON DELETE CASCADE,
